...
export interface UnicornRuleOptions {
  /*
...
// ----- escape-case -----
type EscapeCase = []|[("uppercase" | "lowercase")]
...
type ImportStyle = []|[{
  ...
  styles?: _ImportStyle_ModuleStyles
}]
type _ImportStyleStyles = (false | _ImportStyle_BooleanObject) | undefined
interface _ImportStyle_ModuleStyles {
  [k: string]: _ImportStyleStyles | undefined
}
interface _ImportStyle_BooleanObject {
  [k: string]: boolean | undefined
}
// ----- isolated-functions -----
type IsolatedFunctions = []|[{
...
// ----- number-literal-case -----
type NumberLiteralCase = []|[{
  hexadecimalValue?: ("uppercase" | "lowercase")
}]
// ----- numeric-separators-style -----
type NumericSeparatorsStyle = []|[{
  binary?: {
...
type PreferAddEventListener = []|[{
  
  excludedPackages?: string[]
}]
// ----- prefer-array-find -----
type PreferArrayFind = []|[{
  
  checkFromLast?: boolean
}]
// ----- prefer-array-flat -----
type PreferArrayFlat = []|[{
...
// ----- prefer-ternary -----
type PreferTernary = []|[("always" | "only-single-line")]
// ----- prevent-abbreviations -----
type PreventAbbreviations = []|[{
  ...
  replacements?: _PreventAbbreviations_Abbreviations
  
  extendDefaultAllowList?: boolean
  allowList?: _PreventAbbreviations_BooleanObject
  
  ignore?: unknown[]
}]
type _PreventAbbreviationsReplacements = (false | _PreventAbbreviations_BooleanObject) | undefined
interface _PreventAbbreviations_Abbreviations {
  [k: string]: _PreventAbbreviationsReplacements | undefined
}
...
// ----- relative-url-style -----
type RelativeUrlStyle = []|[("never" | "always")]
// ----- string-content -----
type StringContent = []|[{
...
// ----- switch-case-braces -----
type SwitchCaseBraces = []|[("always" | "avoid")]
// ----- template-indent -----
type TemplateIndent = []|[{
