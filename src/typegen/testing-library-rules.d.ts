...
export interface TestingLibraryRuleOptions {
  /*
   ...
   */
  'testing-library/await-async-events'?: Linter.RuleEntry<AwaitAsyncEvents>;
  /*
   ...
   */
  'testing-library/consistent-data-testid'?: Linter.RuleEntry<ConsistentDataTestid>;
  /*
   ...
   */
  'testing-library/no-await-sync-events'?: Linter.RuleEntry<NoAwaitSyncEvents>;
  /*
   ...
   */
  'testing-library/no-debugging-utils'?: Linter.RuleEntry<NoDebuggingUtils>;
  /*
   * Disallow importing from DOM Testing Library
   * @see https://github.com/testing-library/eslint-plugin-testing-library/tree/main/docs/rules/no-dom-import.md
   */
  'testing-library/no-dom-import'?: Linter.RuleEntry<NoDomImport>;
  /*
   ...
   */
  'testing-library/no-node-access'?: Linter.RuleEntry<NoNodeAccess>;
  /*
   ...
   */
  'testing-library/no-render-in-lifecycle'?: Linter.RuleEntry<NoRenderInLifecycle>;
  /*
   ...
   */
  'testing-library/no-unnecessary-act'?: Linter.RuleEntry<NoUnnecessaryAct>;
  /*
   ...
   */
  'testing-library/prefer-explicit-assert'?: Linter.RuleEntry<PreferExplicitAssert>;
  /*
   ...
   */
  'testing-library/prefer-presence-queries'?: Linter.RuleEntry<PreferPresenceQueries>;
  /*
   ...
   */
  'testing-library/prefer-query-matchers'?: Linter.RuleEntry<PreferQueryMatchers>;
  /*
   ...
   */
  'testing-library/prefer-user-event'?: Linter.RuleEntry<PreferUserEvent>;
  /*
