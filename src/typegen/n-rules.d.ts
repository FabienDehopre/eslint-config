...
export interface NRuleOptions {
   ...
   */
  'n/handle-callback-err'?: Linter.RuleEntry<HandleCallbackErr>;
  /*
   * require correct usage of hashbang
   * @see https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/hashbang.md
   */
  'n/hashbang'?: Linter.RuleEntry<Hashbang>;
  /*
   ...
   */
  'n/no-deprecated-api'?: Linter.RuleEntry<NoDeprecatedApi>;
  /*
   ...
   */
  'n/no-process-env'?: Linter.RuleEntry<NoProcessEnv>;
  /*
   ...
   */
  'n/no-unsupported-features/es-builtins'?: Linter.RuleEntry<NoUnsupportedFeaturesEsBuiltins>;
  /*
   ...
   */
  'n/no-unsupported-features/es-syntax'?: Linter.RuleEntry<NoUnsupportedFeaturesEsSyntax>;
  /*
   ...
   */
  'n/no-unsupported-features/node-builtins'?: Linter.RuleEntry<NoUnsupportedFeaturesNodeBuiltins>;
  /*
   * enforce either `Buffer` or `require("buffer").Buffer`
   * @see https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/buffer.md
   */
  'n/prefer-global/buffer'?: Linter.RuleEntry<PreferGlobalBuffer>;
  /*
   * enforce either `console` or `require("console")`
   * @see https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/console.md
   */
  'n/prefer-global/console'?: Linter.RuleEntry<PreferGlobalConsole>;
  /*
   * enforce either `crypto` or `require("crypto").webcrypto`
   * @see https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/crypto.md
   */
  'n/prefer-global/crypto'?: Linter.RuleEntry<PreferGlobalCrypto>;
  /*
   * enforce either `process` or `require("process")`
   * @see https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/process.md
   */
  'n/prefer-global/process'?: Linter.RuleEntry<PreferGlobalProcess>;
  /*
   * enforce either `TextDecoder` or `require("util").TextDecoder`
   * @see https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/text-decoder.md
   */
  'n/prefer-global/text-decoder'?: Linter.RuleEntry<PreferGlobalTextDecoder>;
  /*
   * enforce either `TextEncoder` or `require("util").TextEncoder`
   * @see https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/text-encoder.md
   */
  'n/prefer-global/text-encoder'?: Linter.RuleEntry<PreferGlobalTextEncoder>;
  /*
   * enforce either global timer functions or `require("timers")`
   * @see https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/timers.md
   */
  'n/prefer-global/timers'?: Linter.RuleEntry<PreferGlobalTimers>;
  /*
   * enforce either `URL` or `require("url").URL`
   * @see https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-global/url.md
   */
  'n/prefer-global/url'?: Linter.RuleEntry<PreferGlobalUrl>;
  /*
   ...
   */
  'n/prefer-global/url-search-params'?: Linter.RuleEntry<PreferGlobalUrlSearchParams>;
  /*
   * enforce using the `node:` protocol when importing Node.js builtin modules.
   * @see https://github.com/eslint-community/eslint-plugin-n/blob/HEAD/docs/rules/prefer-node-protocol.md
   */
  'n/prefer-node-protocol'?: Linter.RuleEntry<PreferNodeProtocol>;
  /*
   ...
   * @deprecated
   */
  'n/shebang'?: Linter.RuleEntry<Shebang>;
}

// ----- callback-return -----
type CallbackReturn = []|[string[]]
// ----- exports-style -----
type ExportsStyle = []|[("module.exports" | "exports")]|[("module.exports" | "exports"), {
  allowBatchAssign?: boolean
}]
// ----- file-extension-in-import -----
type FileExtensionInImport = []|[("always" | "never")]|[("always" | "never"), {
...
type NoRestrictedImport = []|[(string | {
  name: (string | string[])
  message?: string
})[]]
// ----- no-restricted-require -----
type NoRestrictedRequire = []|[(string | {
  name: (string | string[])
  message?: string
})[]]
// ----- no-sync -----
...
type NoUnsupportedFeaturesEsBuiltins = []|[{
  version?: string
...
type NoUnsupportedFeaturesEsSyntax = []|[{
  version?: string
...
type PreferGlobalBuffer = []|[("always" | "never")]
// ----- prefer-global/console -----
type PreferGlobalConsole = []|[("always" | "never")]
// ----- prefer-global/crypto -----
type PreferGlobalCrypto = []|[("always" | "never")]
// ----- prefer-global/process -----
type PreferGlobalProcess = []|[("always" | "never")]
// ----- prefer-global/text-decoder -----
type PreferGlobalTextDecoder = []|[("always" | "never")]
// ----- prefer-global/text-encoder -----
type PreferGlobalTextEncoder = []|[("always" | "never")]
// ----- prefer-global/timers -----
type PreferGlobalTimers = []|[("always" | "never")]
// ----- prefer-global/url -----
type PreferGlobalUrl = []|[("always" | "never")]
// ----- prefer-global/url-search-params -----
type PreferGlobalUrlSearchParams = []|[("always" | "never")]
// ----- prefer-node-protocol -----
type PreferNodeProtocol = []|[{
  version?: string
}]
// ----- shebang -----
type Shebang = []|[{
