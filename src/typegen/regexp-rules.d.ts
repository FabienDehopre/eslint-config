...
export interface RegexpRuleOptions {
  /*
   ...
   */
  'regexp/no-dupe-disjunctions'?: Linter.RuleEntry<NoDupeDisjunctions>;
  /*
   ...
   */
  'regexp/no-obscure-range'?: Linter.RuleEntry<NoObscureRange>;
  /*
   ...
   */
  'regexp/no-super-linear-backtracking'?: Linter.RuleEntry<NoSuperLinearBacktracking>;
  /*
   ...
   */
  'regexp/no-super-linear-move'?: Linter.RuleEntry<NoSuperLinearMove>;
  /*
   ...
   */
  'regexp/no-unused-capturing-group'?: Linter.RuleEntry<NoUnusedCapturingGroup>;
  /*
   ...
   */
  'regexp/no-useless-character-class'?: Linter.RuleEntry<NoUselessCharacterClass>;
  /*
   ...
   */
  'regexp/no-useless-flag'?: Linter.RuleEntry<NoUselessFlag>;
  /*
   ...
   */
  'regexp/no-useless-non-capturing-group'?: Linter.RuleEntry<NoUselessNonCapturingGroup>;
  /*
   ...
   */
  'regexp/optimal-quantifier-concatenation'?: Linter.RuleEntry<OptimalQuantifierConcatenation>;
  /*
   * enforce using character class
   * @see https://ota-meshi.github.io/eslint-plugin-regexp/rules/prefer-character-class.html
   */
  'regexp/prefer-character-class'?: Linter.RuleEntry<PreferCharacterClass>;
  /*
   * enforce using `\d`
   * @see https://ota-meshi.github.io/eslint-plugin-regexp/rules/prefer-d.html
   */
  'regexp/prefer-d'?: Linter.RuleEntry<PreferD>;
  /*
   ...
   */
  'regexp/prefer-lookaround'?: Linter.RuleEntry<PreferLookaround>;
  /*
   ...
   */
  'regexp/prefer-named-replacement'?: Linter.RuleEntry<PreferNamedReplacement>;
  /*
   ...
   */
  'regexp/prefer-quantifier'?: Linter.RuleEntry<PreferQuantifier>;
  /*
   * enforce using `?` quantifier
   ...
   */
  'regexp/prefer-range'?: Linter.RuleEntry<PreferRange>;
  /*
   ...
   */
  'regexp/prefer-result-array-groups'?: Linter.RuleEntry<PreferResultArrayGroups>;
  /*
   ...
   */
  'regexp/sort-character-class-elements'?: Linter.RuleEntry<SortCharacterClassElements>;
  /*
   ...
   */
  'regexp/unicode-escape'?: Linter.RuleEntry<UnicodeEscape>;
  /*
   ...
   */
  'regexp/unicode-property'?: Linter.RuleEntry<UnicodeProperty>;
  /*
...
// ----- hexadecimal-escape -----
type HexadecimalEscape = []|[("always" | "never")]
// ----- letter-case -----
type LetterCase = []|[{
...
type NoSuperLinearBacktracking = []|[{
  report?: ("certain" | "potential")
}]
// ----- no-super-linear-move -----
type NoSuperLinearMove = []|[{
  report?: ("certain" | "potential")
  ignoreSticky?: boolean
  ignorePartial?: boolean
}]
// ----- no-unused-capturing-group -----
type NoUnusedCapturingGroup = []|[{
  fixable?: boolean
  allowNamed?: boolean
}]
// ----- no-useless-character-class -----
type NoUselessCharacterClass = []|[{
  ignores?: string[]
}]
// ----- no-useless-flag -----
type NoUselessFlag = []|[{
...
// ----- prefer-lookaround -----
type PreferLookaround = []|[{
  lookbehind?: boolean
  strictTypes?: boolean
}]
// ----- prefer-named-replacement -----
type PreferNamedReplacement = []|[{
  strictTypes?: boolean
}]
// ----- prefer-quantifier -----
type PreferQuantifier = []|[{
  allows?: string[]
}]
// ----- prefer-range -----
type PreferRange = []|[{
...
type PreferResultArrayGroups = []|[{
  strictTypes?: boolean
}]
// ----- sort-character-class-elements -----
type SortCharacterClassElements = []|[{
  order?: ("\\s" | "\\w" | "\\d" | "\\p" | "*" | "\\q" | "[]")[]
}]
// ----- unicode-escape -----
type UnicodeEscape = []|[("unicodeCodePointEscape" | "unicodeEscape")]
// ----- unicode-property -----
