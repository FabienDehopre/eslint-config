...
import { angular, comments, imports, javascript, jsdoc, jsonc, markdown, ngrx, node, perfectionist, playwright, regexp, sortPackageJson, stylistic, tailwindcss, toml, typescript, unicorn, vitest, yaml } from '../src';
